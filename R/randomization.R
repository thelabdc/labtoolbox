#' Generate Lab Seed
#'
#'Use this function to generate a seed for replicable work involving randomization or simulation. At the Lab, we use two types of seeds:
#'\itemize{
...
#' @param seed_type "date" or "sampled"
#'

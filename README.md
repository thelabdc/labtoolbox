...
Alyssa [Huberts](https://github.com/alyssa-huberts), Ryan T.
[Moore](https://github.com/rtm-dc)

The `{labtoolbox}` package provides functions to simplify and automate
common data analysis and presentation tasks for The Lab @ DC.
